"""
Django settings for proctoring_systems project.
...
SECRET_KEY = 'django-insecure-5r4l@+k(pu2gaff^y13@x-gc6#8c&4^)2l24f2a21ziak!co4+'
...
ROOT_URLCONF = 'proctoring_systems.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'proctorings', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'proctoring_systems.wsgi.application'
